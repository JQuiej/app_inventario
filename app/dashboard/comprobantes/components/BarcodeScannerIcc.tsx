// app/dashboard/comprobantes/components/BarcodeScannerIcc.tsx
'use client'
...
export default function BarcodeScannerIcc({ onDetected, onClose }: Props) {
                ...
                if (html5QrCode.getState() === Html5QrcodeScannerState.NOT_STARTED) {
                    await html5QrCode.start(
                        ...
                        (decodedText) => {
                            ...
                            if (cleanCode.length >= 18 && cleanCode.length <= 20) {
                                html5QrCode.pause();
                                setIsScanning(false);
    ...
    return (
        <div className={styles.scannerOverlay}>
            <div className={styles.scannerHeader}>
                <span className="font-bold">Escáner ICC</span>
